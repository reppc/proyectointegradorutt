...
<?php
        ...
        if ($_SESSION['rol']!="Administrador_Blog") 
          {
            ...
            <form id="loginform" action="../Scripts/agreagarPubl.php" method="POST" enctype="multipart/form-data">
              <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="titulo" placeholder="Titulo de la publicacion" required autofocus>
                    <br>
              ...
              <div class="text-center">
                <button type="submit" title="Ingresar" name="ingresar">Publicar entrada</button>
              </div>
            </form>
        </div>
        <br>
