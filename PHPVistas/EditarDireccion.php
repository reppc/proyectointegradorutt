...
<?php
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      ?>
      <div id="contenedor" style="color:white">
    <div id="central">
        <div id="login" style="background-color: #1c8ee0;">
            <div class="titulo">
                Editar Direccion
            </div>
            <form id="loginform" action="../Scripts/editardirec.php" method="POST" enctype="multipart/form-data"
              <div class="row">
                <div class="col">
                    ...
                    <input type="text" name="numero2" placeholder="Num-interior" value="<?=$numero2?>">

                    <label class="form" for="categoria-label">Telefono: </label>
                    <input type="text" name="telefono" placeholder="Escribe tu telefono" value="<?=$telefono?>" required>
                    <label class="form" for="categoria-label">Colonia: </label>
                    <input type="text" name="colonia" placeholder="Escribe la colonia" value="<?=$colonia?>" required>
                    <input hidden type="text" name="id" value="<?=$id?>">

                <br>
              </div>
              <div class="text-center">
                <button type="submit" title="Ingresar" name="ingresar" class="boton2">Actualizar Domicilio</button>
              </div>
            </form>
        </div>
</body>
