    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item" style="margin-right: 5px">
              <a class="nav-link" aria-current="page" href="../../inicio.html">
                ...
                >
                  <path
                    d="M29.1667 11.0887L19.7917 2.65125L5.02917 15.9375H8.33333V30.9375H14.5833V19.6875H25V30.9375H31.25V15.9375H34.5542L31.25 12.9637V6.5625H29.1667V11.0887ZM0 17.8125L19.7917 0L27.0833 6.5625V4.6875H33.3333V12.1875L39.5833 17.8125H33.3333V32.8088H22.9167V21.5588H16.6667V32.8088H6.25V17.8125H0Z"
                    fill="white"
                  />
                </svg>
                Inicio</a
            ...
            <li class="nav-item dropdown" style="margin-right: 5px">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <a
                    class="dropdown-item"
                    href="../../Interfaces-vistas/articulos/home_articulos.html"
                    >articulos</a
                  >
                </li>
                <li>
                  <a
                    class="dropdown-item"
                    href="../../Interfaces-vistas/articulos/interfaces/categorias/categorias.html"
                    >categoria</a
                  >
                </li>
              </ul>
            ...
            <li class="nav-item dropdown" style="margin-right: 5px">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <a
                    class="dropdown-item"
                    href="../../Interfaces-vistas/Blog/pruebaBlog.html"
                    >blog</a
                  >
                </li>
          ...
          <!-- #region boton-->
          <form class="d-flex">
            <a href="login.html" class="btn btn-outline-light" id="redondeado"
              >Acceder</a
            >
          </form>
          <!-- #endregion -->
